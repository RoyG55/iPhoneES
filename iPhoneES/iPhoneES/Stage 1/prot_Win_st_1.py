...
class NewNewWindow2(QDialog):
    ...
    def formulario(self):
        #Crea label principal y define tamano y alineacion
        self.label = QLabel("Corto en linea PP_VDD_MAIN")
        self.label.setFont(QFont("Arial", 20))
        self.label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        #Indicacion principal
        self.mensaje = QLabel("Inyecta tension y revisa con camara termica o rosin que componente esta en corto y reemplazalo")
        ...
        self.mensaje2.setFont(QFont("Arial", 12))
        self.current_path = os.path.dirname(__file__)
        self.image_path = os.path.join(self.current_path, "../iPhoneES", "MAIN.png")
        self.imagen = QPixmap(self.image_path)
        self.imagen_label = QLabel()
...
class NewNewWindow3(QDialog):
    ...
    def formulario(self):
        #Crea label principal y define tamano y alineacion
        self.label = QLabel("Corto en linea PP_VDD_BOOST")
        self.label.setFont(QFont("Arial", 20))
        self.label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.mensaje2.setFont(QFont("Arial", 12))
        self.current_path = os.path.dirname(__file__)
        self.image_path = os.path.join(self.current_path, "../iPhoneES", "BOOST.png")
        self.imagen = QPixmap(self.image_path)
        self.imagen_label = QLabel()
